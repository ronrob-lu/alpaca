...
creatura.register_mob("lmgjam_notloc_alpac_alachia:alpaca", {
	-- Engine Props
	visual_size = {x = 1, y = 1},
	...
	animations = {
		stand = {range = {x = 1, y = 110}, speed = 48, frame_blend = 0.3, loop = true},
		walk = {range = {x = 115, y = 135}, speed = 24, frame_blend = 0.3, loop = true},
		run = {range = {x = 115, y = 135}, speed = 48, frame_blend = 0.3, loop = true},
		eat = {range = {x = 140, y = 180}, speed = 48, frame_blend = 0.3, loop = false}
	},
...
creatura.register_spawn_item("lmgjam_notloc_alpac_alachia:alpaca", {
	col1 = "f4e6cf",
	col2 = "e1ca9b"
})